package com.example.blog_jpa.blog.ctrl;
...
public class BlogController {
    ...
    */
    ...
    public ResponseEntity<Void> write(
        ...
        // 서비스와 연계
        BlogResponseDTO blogResponseDTO = blogService.write(blogRequestDTO);
    ...
    */
    ...
    public void delete(@PathVariable("blogId") Integer blogId){
    ...
    public ResponseEntity<Void> update(@PathVariable("blogId") Integer blogId, 
        ...
        BlogResponseDTO blogResponseDTO = blogService.update(blogId, blogRequestDTO);
        if(blogResponseDTO != null){
